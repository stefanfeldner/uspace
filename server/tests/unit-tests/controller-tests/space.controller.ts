...
export const spaceControllerTests = (): void => {
  describe('Testing Space Controller', () => {
    it('postSpace() Should send space data in request to model and return the saved space', async () => {
    ...
    it('postSpace() Should handle errors thrown by the model', async () => {
    ...
    it('getSpaceData() Should send the spacedata received by the model to the client', async () => {
    ...
    it('getSpaceData() Should send a 404 if no space is found with the passed in ID', async () => {
    ...
    it('getSpaceData() Should send a 500 if a error comes back from the model', async () => {
    ...
    it('deleteSpace() Should send the id of the deleted space', async () => {
    ...
    it('deleteSpace() Should send a 500 if a error comes back from the model', async () => {
      const mReq = { params: { id: 'hello' } } as any as Request;
      const mRes = { status: jest.fn().mockReturnThis(), send: jest.fn() } as any as Response;
      await deleteSpace(mReq, mRes);
      expect(mRes.status).toBeCalledWith(500);
