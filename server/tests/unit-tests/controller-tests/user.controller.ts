...
export const userControllerTests = (): void => {
  describe('Testing User Controller', () => {
  // Testing Post Comment
    it('Should send user data in request to model and return the saved comment', async () => {
    ...
    it('Should return user data if it is found in the database', async () => {
    ...
    it('Should handle error for user not found', async () => {
    ...
    it('Should handle errors for all other cases', async () => {
